...
if /I "%~1"=="replay-sync" goto replay_sync
...
if /I "%~1"=="accelerator" goto accelerator
...
:replay_sync
shift
python scripts\forks\replay_sync.py %1 %2 %3 %4 %5 %6 %7 %8 %9
exit /b %errorlevel%

:ensure_node_toolchains
shift
python scripts\forks\ensure_node_toolchains.py %1 %2 %3 %4 %5 %6 %7 %8 %9
exit /b %errorlevel%
...
:accelerator
shift
python scripts\forks\accelerator.py %1 %2 %3 %4 %5 %6 %7 %8 %9
exit /b %errorlevel%
