...
const VALUE_FLAGS = ['--out','--seed','--trials','--support','--step','--shallow-strength','--deep-strength','--smoothness-weight','--edge-weight','--complexity-weight','--grid','--image-id','--source-tool','--feature','--label','--strength','--layers','--tries','--metric','--depth','--patience','--threshold'];
