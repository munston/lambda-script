...
The central requirement is that every new metric must name its safety function. It must state what it supports, what it can accidentally reward, and what gate prevents misuse.
